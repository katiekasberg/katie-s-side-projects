...
CREATE TABLE transfer (
	...
	CONSTRAINT FK_from_user FOREIGN KEY (from_user_id) REFERENCES tenmo_user (user_id),
	CONSTRAINT FK_to_user FOREIGN KEY (to_user_id) REFERENCES tenmo_user (user_id)
);
...
INSERT INTO transfer (from_user_id, to_user_id, amount)
	VALUES(1001, 1002, 100);
